...
sed -i "s/OpenWrt /WeiZi Build $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" package/lean/default-settings/files/zzz-default-settings

# Modify default IP（FROM 192.168.1.1 CHANGE TO 10.10.10.1）
sed -i 's/192.168.1.3/10.10.10.1/g' package/base-files/files/bin/config_generate
